##################################################
# Adapted from https://github.com/nurfikri89/cmssw/blob/from14011_puppiJetsReclusteringFromMini/PhysicsTools/PatAlgos/python/tools/puppiJetMETReclusteringTools.py
# Author: nurfikri89
##################################################
...
def puppiAK8ReclusterFromMiniAOD(process, runOnMC, useExistingWeights, btagDiscriminatorsAK8=None, btagDiscriminatorsAK8Subjets=None, custom_dict=dict()):
  task = getPatAlgosToolsTask(process)
  ...
  updateJetCollectionCustom = custom_dict.get('updateJetCollection', updateJetCollection)
