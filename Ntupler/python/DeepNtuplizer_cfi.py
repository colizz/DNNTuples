...
deepntuplizer = cms.EDAnalyzer('DeepNtuplizer',
                                ...
                                bDiscriminatorsCompactSave1 = cms.vstring(),
                                bDiscriminatorsCompactSave2 = cms.vstring(),
                                bDiscriminatorsCompactSave3 = cms.vstring(),
                                bDiscriminatorsCompactSave4 = cms.vstring(),
                                bDiscriminatorsCompactSave5 = cms.vstring(),
                                METs          = cms.InputTag("slimmedMETs"),
                                addMET        = cms.untracked.bool(False),
                                addLowLevel   = cms.untracked.bool(True),
                                HLTBits       = cms.InputTag("TriggerResults", "", "HLT"),
                                HLTPrescales  = cms.InputTag("patTrigger"),
                                HLTObjects    = cms.InputTag("selectedPatTrigger"),
                                addHLT        = cms.untracked.bool(False),
