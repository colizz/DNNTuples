...
pfMassDecorrelatedInclParticleTransformerV3HidLayerJetTags = boostedJetONNXJetTagsProducer.clone(
    ...
    preprocess_json = 'DeepNTuples/Ntupler/data/InclParticleTransformer-MD/ak8/V03/preprocess.json',
    model_path = 'DeepNTuples/Ntupler/data/InclParticleTransformer-MD/ak8/V03/model.onnx',
    flav_names = [
